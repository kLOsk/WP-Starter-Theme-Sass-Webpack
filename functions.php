...
function xsbf_load_fonts()
{
    ...
    if (isset($xsbf_theme_options['fontawesome']) and $xsbf_theme_options['fontawesome']) {
        wp_register_style('font-awesome', get_template_directory_uri() . '/assets/vendor/font-awesome/css/font-awesome.min.css', array(), '4.5.0', 'all');
...
function xsbf_load_css()
{
    ...
    wp_register_style('bootstrap', get_template_directory_uri() . '/assets/vendor/bootstrap/css/bootstrap.min.css', array(), '3.3.7', 'all');
    ...
    if ($xsbf_theme_options['bootstrap_gradients']) {
        wp_register_style('bootstrap-theme', get_template_directory_uri() . '/assets/vendor/bootstrap/css/bootstrap-theme.min.css', array( 'bootstrap' ), '3.3.7', 'all');
        wp_enqueue_style('bootstrap-theme');
    }

    // Our base WordPress CSS that handles default margins, paddings, etc.
    wp_register_style('theme', get_template_directory_uri() . '/assets/css/app.bundle.css', array( 'bootstrap' ), '20160323', 'all');
...
function xsbf_load_js()
{
    ...
    if ($xsbf_theme_options['touch_support'] and wp_is_mobile() and is_singular()) {
        wp_enqueue_script('jquerymobile', get_template_directory_uri() . '/assets/vendor/jquerymobile/jquery.mobile.custom.min.js', array('jquery'), '1.4.0', true);
    }

    // Our theme's javascript for smooth scrolling and optional for touch carousels
    wp_enqueue_script('theme', get_template_directory_uri() . '/assets/js/app.bundle.js', array('jquery'), '20160303', true);

    // Optional script from _S theme to allow keyboard navigation through image pages
    if ($xsbf_theme_options['image_keyboard_nav'] and is_singular() and wp_attachment_is_image()) {
        wp_enqueue_script('keyboard-image-navigation', get_template_directory_uri() . '/assets/js/keyboard-image-navigation.js', array('jquery'), '20120202', true);
    }
    ...
    if ($browser and $browser[1] < 9) {
        wp_enqueue_script('html5shiv', get_template_directory_uri() . '/assets/vendor/html5/html5shiv.min.js', null, '3.7.3', true);
        wp_enqueue_script('respond', get_template_directory_uri() . '/assets/vendor/html5/respond.min.js', null, '1.4.2', true);
    }
